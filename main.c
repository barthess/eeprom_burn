...
static uint8_t databuf[EEPROM_SIZE];
static uint8_t testbuf[EEPROM_SIZE];
 ...
 */
static WORKING_AREA(waBurner, 512);
static msg_t Burner(void *arg) {
  chRegSetThreadName("burner");
